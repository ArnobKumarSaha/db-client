module kubedb.dev/schema-manager
...
require (
	...
	kubedb.dev/apimachinery v0.22.1-0.20211102211514-1cef683735f7
	kubedb.dev/db-client-go v0.0.0-20211109110514-ee6d57a78931
