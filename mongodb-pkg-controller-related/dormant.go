...
// waitUntilHalted & haltDatabase will be called from halt() of mongodb.go .  Other files are internal

/*
This function waits for the completion of deletion. It uses below two function and  some other functions from core_util to do this
 */
...
=> appBindings, PodDisruptionBudgets, StatefulSet, Deployment, roleBinding, Role, serviceAccount, services
deleteMonitor
 */
