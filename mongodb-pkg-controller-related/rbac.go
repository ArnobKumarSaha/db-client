...
/*
createServiceAccount, ensureRole & createRoleBinding are very straight-forward. They are responsible to create sa, role & crb respectively
 */
...
/*
Gets the databaseVersion & then returns the PolicyName from that
 */
...
/*
All other funcs of this file will be called from this func
It contains a createDatabaseRBAC func which takes a podTemplateSpec
