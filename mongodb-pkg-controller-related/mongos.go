...
/*
This will be called from ensureTopologyCluster() of statefulSet.go
Get the mongoDBVersion, assign default values of sslMode, clusterAuth, cmds, args
make the shardDSN string
installInitContainer
assign defaults values of envList, volumes, volumeMounts
mongosInitContainer
Build the workloadOptions
ensureStatefulSet
 */
...
/*
assign the default values of envList , sslMode, clusterAuth
create the bootstrap container
set volumes and volumeMounts after checking keyFileSecret & Init.script of db.spec
 */
